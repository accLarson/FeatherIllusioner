package com.zerek.featherillusioner.tasks;
...
public class FightInitiateTask extends BukkitRunnable {
    ...
    public FightInitiateTask(FeatherIllusioner plugin, Illusioner illusioner, Location loc, BossBar bossBar, List<Vex> vexes, Player summoner) {
        this.plugin = plugin;
